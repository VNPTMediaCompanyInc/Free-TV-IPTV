...
You may still check with the "streams:>0" parameter in the search bar to check all available streams.
...
### We do accept links to Xtream Codes servers?

Xtream Codes streams tend to be very stable, and often links to them very quickly, so it's easier for us to initially exclude them from the playlist than to search for ones every day.
